                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            <a href="{{ route('admin.po') }}" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline">Purchasing Order</span> 
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.bar') }}" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline">Bar Request</span> </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.kitchen') }}" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline">Kitchen Request</span> </a>
                        </li>
                    </ul>
                    <hr>
