                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Tambahkan satu data</label>
                            <br>
                            <button type="submit" class="badge text-bg-primary" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Add</button>                            
                          </div>
                        </div>
                        <br><br><hr><br>
                        <table class="table">
